...
const Footer = () => {
  return (
    ...
    <div className='icons__footer'>
            ...
            <div className='item__icons'>
            <a href="https://github.com/CrisPer1988" target="_blank"><i className='bx bxl-github' ></i></a>
            <h5>GitHub</h5>
            </div>

            <div className='item__icons'>          
            <a href="https://wa.me/5492622468440" target="_blank"><i className='bx bxl-whatsapp'></i></a>
            <h5>WhatsApp</h5>
            </div>

            <div className='item__icons'>
            <a href="/images/CV-actualizado.pdf" target="_blank"><i className='bx bx-download'></i></a>
            <h5>CV</h5>
            </div>
        </div>
